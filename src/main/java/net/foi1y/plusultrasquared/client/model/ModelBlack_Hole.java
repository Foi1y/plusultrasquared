package net.foi1y.plusultrasquared.client.model;
...
public class ModelBlack_Hole<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("plusultrasquared", "model_black_hole"), "main");
