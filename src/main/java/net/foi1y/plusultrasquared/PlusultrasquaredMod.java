...
@Mod("plusultrasquared")
public class PlusultrasquaredMod {
	public static final Logger LOGGER = LogManager.getLogger(PlusultrasquaredMod.class);
	public static final String MODID = "plusultrasquared";

	public PlusultrasquaredMod() {
